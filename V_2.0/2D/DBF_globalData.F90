...
module DBF_globalData
    ...
    real(kind=8), dimension(:), pointer :: local_rhs, local_rhs_static, local_rhs_Cf, local_rhs_Tem
    integer, dimension(:), pointer :: AxxCols, AxpCols, AyyCols, AypCols, AcxCols, AcyCols, AcpCols, AcfCols, AtemCols
    integer, dimension(:), pointer :: AxxRows, AxpRows, AyyRows, AypRows, AcxRows, AcyRows, AcpRows, AcfRows, AtemRows
    real(kind=8), dimension(:), pointer :: AxxValues, AxpValues, AyyValues, AypValues, AcxValues, &!
        AcyValues, AcpValues, AxxStaticValues, AxxDynValues, AyyStaticValues, AyyDynValues, AcfValues, AtemValues
    integer :: AxxSize, AxpSize, AyySize, AypSize, AcxSize, AcySize, AcpSize, AcfSize, AtemSize
    integer, dimension(:), pointer :: AxxEntryNum, AxpEntryNum, AyyEntryNum, AypEntryNum, AcxEntryNum, &!
        AcyEntryNum, AcpEntryNum, AcfEntryNum, AtemEntryNum
    integer, dimension(:), pointer :: AxxEntryBase, AxpEntryBase, AyyEntryBase, AypEntryBase, AcxEntryBase, &!
        AcyEntryBase, AcpEntryBase, AcfEntryBase, AtemEntryBase
    ...
    integer, dimension(:), allocatable ::  mumps_IRN_loc, mumps_JCN_loc, &!
        mumps_IRN_loc_Cf, mumps_JCN_loc_Cf, mumps_IRN_loc_Tem, mumps_JCN_loc_Tem
    ...
    integer(kind=8) :: precond, solver, precond_Cf, solver_Cf, precond_Tem, solver_Tem
