...
contains
    ...
    subroutine export2tecplot(g_poro, g_Kxx, g_vx, g_vy, g_vz, g_p, g_Cf, g_Tem)
        ...
        allocate(Tem_a(nx+1,ny+1,nz+1))
        allocate(vars_a(nx+1,ny+1,nz+1,8))
        ...
        call exportPointCenteredIJK_vars(vars_a, (/"poro", "Kxx ", "vx  ", "vy  ", "vz  ", "p   ", "Cf  ", "Tem "/), &!
