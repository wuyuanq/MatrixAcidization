...
contains
    ...
    subroutine export2tecplot(g_poro, g_Kxx, g_vx, g_vy, g_p, g_Cf, g_Tem)
        ...
        call exportPointCenteredIJ_vars(vars_a, (/"poro", "Kxx ", "vx  ", "vy  ", "p   ", "Cf  ", "Tem "/), &!
