...
program DBF_infile
    ...
    deallocate(random)
    ! add the fracture
    modelCase%poroInit(21:80,10) = 0.7
    modelCase%poroInit(21:80,20) = 0.7
    modelCase%poroInit(21:80,30) = 0.7
    ...
    ! add the fracture
    modelCase%KxxInit(21:80,10) = 1.D-12
    modelCase%KxxInit(21:80,20) = 1.D-12
    modelCase%KxxInit(21:80,30) = 1.D-12
    modelCase%KyyInit(21:80,10) = 1.D-12
    modelCase%KyyInit(21:80,20) = 1.D-12
    modelCase%KyyInit(21:80,30) = 1.D-12
...
The breakthrough time is    268.00000000000000       seconds.
 The pore volume to breakthrough is   0.13400000000000001
 Solver time =    93.196732491371222       seconds.
 Elapsed time =    98.407143661985174       seconds.
