...
program DBF_infile
    ...
    modelCase%KxxInit(:,:) = 1.D-16!9.869233D-16
    allocate(modelCase%KyyInit(modelCase%nx,modelCase%ny))
    modelCase%KyyInit(:,:) = 1.D-16!9.869233D-16
    ! add the fracture
    do i = 11, 20
        j = 52 - 2*i
        modelCase%KxxInit(i,j) = 1.D-13
        modelCase%KxxInit(i,j-1) = 1.D-13
        modelCase%KyyInit(i,j) = 1.D-13
        modelCase%KyyInit(i,j-1) = 1.D-13
    end do
    do i = 31, 40
        j = 2*i - 51
        modelCase%KxxInit(i,j) = 1.D-13
...
The breakthrough time is    465.00000000000000       seconds.
 ...
 Solver time =    159.09929868282052       seconds.
 Elapsed time =    166.30101994000142       seconds.
