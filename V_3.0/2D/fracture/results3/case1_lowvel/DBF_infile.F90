...
program DBF_infile
    ...
    modelCase%vxBdryX0(:) = -2.5D-4!-4.17D-6!!!!
...
The breakthrough time is    836.00000000000000       seconds.
 The pore volume to breakthrough is   0.20899999999999999
 Solver time =    289.36807191069238       seconds.
 Elapsed time =    302.20584256702568       seconds.
