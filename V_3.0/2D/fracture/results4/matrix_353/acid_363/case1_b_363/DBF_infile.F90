...
program DBF_infile
    ...
    do i = 21, 78, 3
        ...
        modelCase%poroInit(i+1,j) = 0.7
        modelCase%poroInit(i+2,j) = 0.7
    end do
    ...
    do i = 21, 78, 3
        ...
        modelCase%KxxInit(i+1,j) = 1.D-12
        modelCase%KxxInit(i+2,j) = 1.D-12
        modelCase%KyyInit(i,j) = 1.D-12
        modelCase%KyyInit(i+1,j) = 1.D-12
        modelCase%KyyInit(i+2,j) = 1.D-12
    end do
    ...
    modelCase%vxBdryX0(:) = -5.D-4!-4.17D-6!!!!
...
The normalized pressure drop =    77.320404101611089      %
The normalized pressure drop =    47.194005481339971      %
The normalized pressure drop =    34.026883467471755      %
The normalized pressure drop =    16.151644117332641      %
The normalized pressure drop =    10.723055872745574      %
The normalized pressure drop =    84.111448360620216      %
Program stops now, but breakthrough has NOT been achieved.
More simulation time is needed to achieve breakthrough!
Solver time =    282.14221411652397       seconds.
Elapsed time =    296.36610806605313       seconds.
