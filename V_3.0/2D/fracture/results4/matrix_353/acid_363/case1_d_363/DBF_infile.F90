...
program DBF_infile
    ...
    deallocate(random)
    ! add the fracture
    modelCase%poroInit(21:80,20) = 0.7
    ...
    ! add the fracture
    modelCase%KxxInit(21:80,20) = 1.D-12
    modelCase%KyyInit(21:80,20) = 1.D-12
...
The normalized pressure drop =    47.131967023972670      %
 The normalized pressure drop =    44.101404284119049      %
 The normalized pressure drop =    27.149054350103203      %
 The normalized pressure drop =    27.669341203135250      %
 The normalized pressure drop =    27.435537032656931      %
 The normalized pressure drop =    26.612706489639748      %
 Program stops now, but breakthrough has NOT been achieved.
 More simulation time is needed to achieve breakthrough!
 Solver time =    270.45518183396052       seconds.
 Elapsed time =    283.55473001900100       seconds.
