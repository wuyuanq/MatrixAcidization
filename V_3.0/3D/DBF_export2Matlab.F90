...
contains
    ...
    subroutine export2Matlab()
        ...
        write(10, fmt="(a)") "path('/Users/yuanqingwu/research/MatrixAcidization/V_3.0/3D', path);"
        ...
        write(10, fmt="(a)") "DBF_plot(model, fporotxt, fKxxtxt, fvxtxt, fvytxt, fvztxt, fptxt, fCftxt, fTemtxt, NUMFRAME);"
        write(10, fmt="(a)") &!
            "DBF_his(model, fporohistxt, fKxxhistxt, favhistxt, fphistxt, fCfhistxt, fTemhistxt, fqhistxt, flphistxt);"
        write(10, fmt="(a)") "rmpath('/Users/yuanqingwu/research/MatrixAcidization/V_3.0/3D');"
