...
contains
    ...
    subroutine export2Matlab()
        ...
        character(len=8) :: charLx, charLy, charLz
        ...
        write(10, fmt="(a)") "path('/Users/yuanqingwu/research/MatrixAcidization/V_1.0/3D', path);"
        write(charLx,'(f8.4)') Lx
        write(10, fmt="(a)") "Lx = "//trim(adjustl(charLx))//";"
        write(charLy,'(f8.4)') Ly
        write(10, fmt="(a)") "Ly = "//trim(adjustl(charLy))//";"
        write(charLz,'(f8.4)') Lz
        write(10, fmt="(a)") "Lz = "//trim(adjustl(charLz))//";"
        ...
        write(charnz,'(i5)') nz
        write(10, fmt="(a)") "nz = "//trim(adjustl(charnz))//";"
        write(charnt,'(i10)') nt
        ...
        write(10, fmt="(a)") "fvztxt = 'soln_vz_raw_"//trim(adjustl(chart))//".txt';"
        ...
        write(10, fmt="(a)") "DBF_plot(model, fporotxt, fKxxtxt, fvxtxt, fvytxt, fvztxt, fptxt, fCftxt, NUMFRAME);"
        write(10, fmt="(a)") &!
            "DBF_his(model, fporohistxt, fKxxhistxt, favhistxt, fphistxt, fCfhistxt, fqhistxt, flphistxt);"
        write(10, fmt="(a)") "rmpath('/Users/yuanqingwu/research/MatrixAcidization/V_1.0/3D');"
