        ...
        do k = indexf, indexb
            do j = indexd, indexu
                do i = indexl, indexr
                    ...
                    dl = alphaOS*dm + 2.D0*lamdaX*vmodulus*radiusInit*(1.D0-poroHarmXInit(i,j,k))/ &!
                        (poroHarmXInit(i,j,k)*(1.D0-poroHarmX(i,j,k)))
                    dt = alphaOS*dm + 2.D0*lamdaT*vmodulus*radiusInit*(1.D0-poroHarmXInit(i,j,k))/ &!
                        (poroHarmXInit(i,j,k)*(1.D0-poroHarmX(i,j,k)))

                    Dx(i,j,k,1) = (dm+vmodulus*dt) + vmodulus*(dl-dt)*Ex(i,j,k,1)
        ...
        do k = indexf, indexb
            do j = indexd, indexu
                do i = indexl, indexr
                    ...
                    dl = alphaOS*dm + 2.D0*lamdaX*vmodulus*radiusInit*(1.D0-poroHarmYInit(i,j,k))/ &!
                        (poroHarmYInit(i,j,k)*(1.D0-poroHarmY(i,j,k)))
                    dt = alphaOS*dm + 2.D0*lamdaT*vmodulus*radiusInit*(1.D0-poroHarmYInit(i,j,k))/ &!
                        (poroHarmYInit(i,j,k)*(1.D0-poroHarmY(i,j,k)))

                    Dy(i,j,k,1) = vmodulus*(dl-dt)*Ey(i,j,k,1)
                    Dy(i,j,k,2) = (dm+vmodulus*dt) + vmodulus*(dl-dt)*Ey(i,j,k,2)
        ...
        do k = indexf, indexb
            do j = indexd, indexu
                do i = indexl, indexr
                    ...
                    dl = alphaOS*dm + 2.D0*lamdaX*vmodulus*radiusInit*(1.D0-poroHarmZInit(i,j,k))/ &!
                        (poroHarmZInit(i,j,k)*(1.D0-poroHarmZ(i,j,k)))
                    dt = alphaOS*dm + 2.D0*lamdaT*vmodulus*radiusInit*(1.D0-poroHarmZInit(i,j,k))/ &!
                        (poroHarmZInit(i,j,k)*(1.D0-poroHarmZ(i,j,k)))

                    Dz(i,j,k,1) = vmodulus*(dl-dt)*Ez(i,j,k,1)
                    Dz(i,j,k,2) = vmodulus*(dl-dt)*Ez(i,j,k,2)
                    Dz(i,j,k,3) = (dm+vmodulus*dt) + vmodulus*(dl-dt)*Ez(i,j,k,3)
        ...
        do k = 1, localnlays
            do j = 1, localnrows
                do i = 1, localncols
                    ...
                    reaction = av(i,j,k)*conc(i,j,k)*kc(i,j,k)*ks/(kc(i,j,k)+ks)
