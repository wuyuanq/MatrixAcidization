...
contains
    ...
    subroutine export2Matlab()
        ...
        write(10, fmt="(a)") "path('/Users/yuanqingwu/research/MatrixAcidization/V_1.0/2D', path);"
        ...
        write(10, fmt="(a)") "DBF_plot(model, fporotxt, fKxxtxt, fvxtxt, fvytxt, fptxt, fCftxt, NUMFRAME);"
        write(10, fmt="(a)") &!
            "DBF_his(model, fporohistxt, fKxxhistxt, favhistxt, fphistxt, fCfhistxt, fqhistxt, flphistxt);"
        write(10, fmt="(a)") "rmpath('/Users/yuanqingwu/research/MatrixAcidization/V_1.0/2D');"
