...
program DBF_infile
    ...
    KyyInit(:,:) = 1.D-15
    ! add the fracture
    KxxInit(20:21,:) = 1.D-12
    KxxInit(:,20:21) = 1.D-12
    KyyInit(20:21,:) = 1.D-12
    KyyInit(:,20:21) = 1.D-12
...
Breakthrough has been achieved! Program stops now.
 The breakthrough time is    354935.00000000000       seconds.
 The pore volume to breakthrough is    1.4197400000000000
 Solver time =    121949.90731999304       seconds.
 Elapsed time =    133917.76104400001       seconds.
